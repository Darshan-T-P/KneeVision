...
OAI_DATA_DIR = DATA_DIR / "oai"

CLINICAL_MODEL_NAME = os.getenv("CLINICAL_MODEL_NAME", "emilyalsentzer/Bio_ClinicalBERT")
CLINICAL_MAX_LENGTH = int(os.getenv("CLINICAL_MAX_LENGTH", "256"))
